      ...
      <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <article className="surface-card overflow-hidden">
          ...
          <div className="p-5 md:p-6">
            ...
            <h2 className="mt-2 text-2xl font-semibold">{liveNow.title}</h2>
        ...
        <article className="surface-card p-5 md:p-6">
          ...
          <div className="mt-4 grid gap-3">
            {newsItems.slice(0, 3).map((item) => (
              <Link key={item.title} href="/news" className="border border-[var(--line)] p-4 transition hover:bg-[var(--surface-alt)]">
        ...
        <article className="surface-card p-5 md:p-6">
          ...
          <div className="mt-4 grid gap-3">
            {eventItems.slice(0, 2).map((event) => (
              <div key={event.title} className="grid grid-cols-[110px_1fr] gap-3 border border-[var(--line)] p-3">
        ...
        <article className="surface-card p-5 md:p-6">
          ...
          <div className="mt-4 grid gap-3">
            {replayVideos.slice(0, 2).map((video) => (
              <div key={video.title} className="grid grid-cols-[110px_1fr] gap-3 border border-[var(--line)] p-3">
                <div className="relative h-20">
